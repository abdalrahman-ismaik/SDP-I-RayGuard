...
| 25 Sep | Collaboration access/protection setup; T36 | CODEOWNERS and documented PR/CI policy prepared; current GitHub administration access verified | Setup in progress; no teammate invitations sent while usernames are pending. No new model or collection evidence |
